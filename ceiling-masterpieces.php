...
<head>
    ...
    <style>
        ...
        .back-nav {
            position: absolute;
            top: 60px; /* Moved up to increase gap */
            left: 8vw;
            z-index: 100;
        }
    ...
    <section class="product-hero">
        <div class="product-grid">
            ...
            <div class="product-info reveal">
                ...
                <form class="contact-form" style="margin-top: 20px; width: 100%; max-width: 550px;">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/gallery_master_1.png');"></div>
                            <div class="gallery-info">
                                ...
                                <div class="card-footer">
                                    <span class="price">₹1,24,990</span>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/gallery_master_2.png');"></div>
                            <div class="gallery-info">
                                <div class="card-meta">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/gallery_master_3.png');"></div>
                            <div class="gallery-info">
                                <div class="card-meta">
                                ...
                                <div class="card-footer">
                                    <span class="price">₹1,85,000</span>
                                    <button class="add-btn" aria-label="Add to cart">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 5v14M5 12h14"/></svg>
                                    </button>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/gallery_master_4.png');"></div>
                            <div class="gallery-info">
                                <div class="card-meta">
                                    <span class="badge new">New</span>
                                </div>
                                <h4>Radial Eclipse Bloom</h4>
                                <div class="card-footer">
