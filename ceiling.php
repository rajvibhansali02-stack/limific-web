...
<body class="loading">
    ...
    <div class="back-nav">
        <a href="index.php#ceiling" class="back-btn">
    ...
    <section class="details" style="padding-top: 40px; padding-bottom: 120px;">
        ...
        <div class="feature-grid reveal" style="margin-bottom: 100px;">
            <div class="feature-card">
                ...
                <h3>Advanced Thermal Mgmt</h3>
                <p>Custom-engineered aerospace-grade aluminum heat sinks ensure the LED runs cool, extending lifespan to over 50,000 hours.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                ...
                <h3>Anti-Glare Optics</h3>
                <p>Our proprietary UGR&lt;19 micro-prismatic diffusers distribute light evenly while eliminating harsh visual fatigue.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
