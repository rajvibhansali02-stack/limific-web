        ...
        <div class="variants-container reveal">
            <div class="swiper variantsCarousel">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/gallery_wall_1.png');"></div>
                            <div class="gallery-info">
                                <div class="card-meta">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/gallery_wall_2.png');"></div>
                            <div class="gallery-info">
                                <div class="card-meta">
