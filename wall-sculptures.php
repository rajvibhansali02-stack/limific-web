...
<body class="loading">
    ...
    <div class="back-nav">
        <a href="index.php#wall-sculptures" class="back-btn">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/shop_sconce.webp');"></div>
                            <div class="gallery-info"><h4>Minimalist Sconce</h4></div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/gallery_wall_1.webp');"></div>
                            <div class="gallery-info"><h4>Stone Cast Sconce</h4></div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/cat_outdoor.webp');"></div>
                            <div class="gallery-info"><h4>Architectural Uplight</h4></div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="gallery-card">
                            <div class="gallery-img" style="background-image: url('images/gallery_wall_2.webp');"></div>
                            <div class="gallery-info"><h4>Eclipse Halo Wall Art</h4></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="details" style="padding-top: 40px; padding-bottom: 120px;">
        ...
        <div class="feature-grid reveal" style="margin-bottom: 100px;">
            <div class="feature-card">
                ...
                <h3>Durable Craftsmanship</h3>
                <p>Hand-finished metals and stone castings ensure that each fixture remains a timeless part of your interior architecture.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>
                </div>
                <h3>Secondary Illumination</h3>
                <p>Designed to provide soft, indirect light that eliminates harsh shadows and creates a calming, luxurious environment.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/></svg>
                </div>
                <h3>Visual Depth</h3>
                <p>By emphasizing the textures of your walls, these sculptures add a three-dimensional quality to any room.</p>
            </div>
        </div>
        ...
        <div class="about-container reveal">
            <div class="details-layout">
                <div class="details-text">
                    <p style="margin-bottom: 24px;">Our Wall Sculptures series redefines the role of light in the home. No longer just a functional necessity, these fixtures are designed to be focal points. By integrating edge-lit technology with hand-finished metals, we ensure that each piece tells a unique story of shadow and light.</p>
                    <p>Designed for residential galleries and premium hospitality spaces, the collection bridges the gap between functional illumination and artistic expression. Every component is crafted to enhance the emotional resonance of your space.</p>
                </div>
                <div class="advantages-box">
                    ...
                    <ul class="advantages-list">
                        <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg> <span>Hand-Finished Artisan Materials</span></li>
                        <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg> <span>Integrated OLED Soft-Light Tech</span></li>
                        <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg> <span>Minimalist Flush-Mount Design</span></li>
                        <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg> <span>Zero Light Leakage Precision</span></li>
                    </ul>
                </div>
            </div>
        </div>
